...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.IDCARD.get())
                .requires(Items.NAME_TAG) // vanilla name tag
                .unlockedBy(getHasName(Items.NAME_TAG), has(Items.NAME_TAG))
                .save(pWriter);
        System.out.println("Generated recipe for IDCARD");
